...
const programsConfig: Array<ProgramData> = [
    { background: '#82f7FF', img: examImg, title: 'Підготовка до НМТ/ЄВІ', programAspects: ["Пояснимо структуру та особливості іспиту", "Навчимо виконувати екзаменаційні завдання", "Опрацюємо типові помилки", "Усунемо прогалини в граматиці", "Підкажемо, як отримати максимальний бал"] },
    { background: '#F44C75', img: pupils, title: 'Школярі', programAspects: ["Знайомимо з граматичними конструкціями англійської мови", "Відпрацьовуємо їх використання в усному та писемному мовленні", "Готуємо до складання НМТ та шкільних іспитів", "Ставимо правильну вимову", "Навчаємо через захопливі теми"] },
    { background: '#CBF86D', img: students, title: 'Студенти', programAspects: ["Пояснюємо складні граматичні конструкції простою мовою", "Розвиваємо навички живого спілкування та ведення діалогів", "Готуємо до міжнародних іспитів та ЄВІ", "Адаптуємо темп і зміст курсу під ваші цілі: навчання, робота, подорожі чи стажування"] },
    ...
    { background: '#FF5A50', img: speakingClubImg, title: 'Розмовні клуби', programAspects: ["Допомагаємо регулярно практикувати англійську", "Поліпшуємо сприйняття мови на слух", "Долаємо мовний бар’єр", "Розвиваємо навички комунікації з однолітками", "Запрошуємо викладачів із усього світу"] },
