...
const programsConfig: Array<ProgramData> = [
    ...
    { background: '#F44C75', img: pupils, title: 'Школярі', programAspects: ['Знайомимо з граматичними конструкціями англійської мови', 'Відпрацьовуємо їх використання в усному та писемному мовленні', 'Готуємо до ДПА та НМТ', 'Ставимо правильну вимову', 'Навчаємо через захоплюючі теми'] },
