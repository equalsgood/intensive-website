...
const questionsConfig: Array<SingleQAProps> = [
    ...
    },
    {
        ...
        an: 'Ми свідомо тримаємо формат саме "міні", щоб зберегти якість навчання. Найчастіше це парні заняття, а максимальна кількість студентів у групі — три особи. Це дозволяє викладачу приділити достатньо уваги кожному.'
    },
    {
        qw: 'Як формуються групи та що робити, якщо немає пари мого рівня?',
        an: 'При підборі групи ми завжди враховуємо вік та рівень знань студентів. Якщо на момент вашого звернення групи відповідного рівня немає, ви зможете розпочати навчання індивідуально за ціною занять у мінігрупі. Вартість для вас не збільшиться, поки ми не підберемо вам напарника.'
    },
    {
    ...
    // БЛОК 3: ОПЛАТА ТА УМОВИ
    {
        ...
        an: 'Ціна формується залежно від обраного формату (індивідуально чи в групі) та діючих пільг або акційних пропозицій. Щоб отримати актуальний розрахунок та дізнатися про поточні знижки, залиште заявку на сайті або зателефонуйте нам — ми з радістю проконсультуємо вас.'
    },
    {
